...
\personalinfo{%
  ...
  \location{Phoenix, AZ / Los Angeles, CA}
...
\cvevent{Senior Software Engineer}{Mobivity}{December 2012 - Ongoing}{San Diego, CA/Chandler, AZ}
\begin{itemize}
...
% \item Produced Vagrant workflow for organization's Rails 2 application.
...
\cvevent{github.com/nelsonjchen/\texttt{cell-shield-go}}{Go/Google Cloud Run/Vue.js}{July 2021 -- Ongoing}{Chandler, AZ / Hacienda Heights, CA}
...
\cvevent{github.com/nelsonjchen/\texttt{github-wiki-see-rs}}{Rust/Google Cloud Run/BigQuery/Python}{April 2021 -- Ongoing}{Chandler, AZ / Hacienda Heights, CA}
...
\cvevent{github.com/HackyExtensionsForZoomMeetings/\texttt{BreakoutRoomsBotForZoomMeetings}}{Javascript/Chrome Extension}{June 2020 -- December 2020}{Chandler, AZ / Hacienda Heights, CA}
...
% \cvevent{gitlab.com/nelsonjchen/\texttt{reverse-rdp-windows-github-actions}}{GitHub Actions/PowerShell/Windows Administration}{December 2019}{San Diego, CA}
...
% \item Was starred on GitHub by many senior developers in the Docker community.
% \end{itemize}
...
% \begin{itemize}
% \item \texttt{PassShout} is a bespoke accessibility service built for Android devices running Eventbrite's Organizer app. A subjective flaw with Eventbrite's Organizer app is that the type of ticket scanned is too small on the screen. When ticket QR codes are scanned, the service will read the type of the ticket scanned out loud to make it more clear what was scanned. Additionally, the app respects Android's audio focus and is able to be used with "music" or a loud looping announcement for attendees being played by controlling those on the device. This is useful for continuously reminding guests to get out their tickets while the badge handler is moving down the line.
% \end{itemize}
...
\cvtag{Windows} \cvtag{Embedded Systems} \cvtag{Go}

\cvtag{CI/CD} \cvtag{AWS} \cvtag{Tooling} \cvtag{Ruby}
...
% \texttt{US10949868B1} - Method and system for single use of electronic retailer coupons and referral program. Contributed the secure and cheap on-site TOTP MFA token verification claim. Reference from Alex Shah can be provided on request
